...
<html lang="en">
  <head>
    ...
    <style>
      .days .day.active {
        background-color: var(--primary, #6200EE); /* Example primary color, adjust as per your theme */
        color: white;
        border-radius: 5px;
        font-weight: bold;
      }
            ...
            <?php foreach ($initialDailyComics as $comic): ?>
                <a href="detail-page.php?work_id=<?php echo $comic['work_id']; ?>" class="comic-card-link">
                    <div class="comic-card">
                        <img src="../<?php echo $comic['thumbnail_url']; ?>" alt="<?php echo htmlspecialchars($comic['title']); ?>" class="comic-cover" />
      ...
      <div class="popup-content">
        ...
        <div class="milestone-grid">
          <div class="milestone-item">
            <img src="../IMG/Coin.png" alt="5 koin" /> <div class="milestone-amount">5 Coins</div>
            <div class="milestone-time">30 minutes</div>
          </div>
          <div class="milestone-item">
            <img src="../IMG/Coin.png" alt="10 koin" /> <div class="milestone-amount">10 Coins</div>
            <div class="milestone-time">60 minutes</div>
          </div>
          <div class="milestone-item">
            <img src="../IMG/Coin.png" alt="15 koin" /> <div class="milestone-amount">15 Coins</div>
            <div class="milestone-time">90 minutes</div>
          </div>
          <div class="milestone-item">
            <img src="../IMG/Coin.png" alt="20 koin" /> <div class="milestone-amount">20 Coin</div>
            <div class="milestone-time">120 minutes</div>
          </div>
          <div class="milestone-item">
            <img src="../IMG/Coin.png" alt="25 koin" /> <div class="milestone-amount">25 Coin</div>
            <div class="milestone-time">150 minutes</div>
          </div>
          <div class="milestone-item">
            <img src="../IMG/Coin.png" alt="30 koin" /> <div class="milestone-amount">30 Coin</div>

    ...
    <main class="main-content">
      <header class="main-header">
        ...
        <div class="header-right">
          <div class="creator-info">
            ...
            <span class="verification-status verified"><i class="fa-solid fa-check-circle"></i> Terverifikasi</span>
          </div>
        </div>
      </header>
      ...
      <div class="content-panel">
        <div class="filter-bar">
          <input type="text" placeholder="Cari komunitas..." class="filter-search" />
        ...
        <div class="community-grid">
          <div class="community-card">
            <div class="card-header" style="
                ...
                ">
              <img src="https://placehold.co/80x80" alt="Avatar Komunitas" class="card-avatar" />
            </div>
            <div class="card-body">
              <h3>Komunitas Pengabdi Kunci Biru</h3>
              <p class="card-members">
                <i class="fa-solid fa-users"></i> 1,200 Anggota
              </p>
              <p class="card-description">
                Grup diskusi resmi untuk para pembaca setia novel "Pengabdi Kunci Biru".
              </p>
              <a href="community-detail.php" class="btn btn-primary full-width">Kunjungi</a>
            </div>
          </div>
          <div class="community-card">
            <div class="card-header" style="

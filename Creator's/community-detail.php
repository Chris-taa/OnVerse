          ...
          <div class="community-content">
            <div class="thread-list">
              ...
              <a href="community-thread.php" class="thread-item">
                <div class="thread-main">
                  <span class="thread-title"
                    >Teori Ending Season 2, Setuju Gak?</span
                  >
                  <span class="thread-meta"
                    >oleh <strong>DepokSlayer</strong> • 2 jam lalu</span
                  >
                </div>
                <div class="thread-stats">
                  <span title="Balasan"
                    ><i class="fa-solid fa-comments"></i> 15</span
                  >
                  <span title="Likes"
                    ><i class="fa-solid fa-thumbs-up"></i> 45</span
                  >
                </div>
              </a>
              <a href="#" class="thread-item">
                <div class="thread-main">
                  <span class="thread-title"
                    >Karakter Favorit Kalian Siapa?</span
                  >
                  <span class="thread-meta"
                    >oleh <strong>AnakBaik</strong> • 5 jam lalu</span
                  >
                </div>
                <div class="thread-stats">
                  <span title="Balasan"
                    ><i class="fa-solid fa-comments"></i> 32</span
                  >
                  <span title="Likes"
                    ><i class="fa-solid fa-thumbs-up"></i> 88</span
                  >
                </div>
              </a>
            </div>
      ...
      <div class="modal-content">
        ...
        <div class="modal-actions">
          <button
            ...
            onclick="closeModal('joinCommunityModal')"
          >
            Batal
          </button>
